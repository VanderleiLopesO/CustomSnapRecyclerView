package com.vanderlei.customsnap.main.ui
...
import com.vanderlei.customsnap.R
import com.vanderlei.customsnap.main.extensions.FULL_DATE
import com.vanderlei.customsnap.main.extensions.toString
import com.vanderlei.customsnap.main.ui.adapter.ListAdapter
import com.vanderlei.customsnap.main.ui.adapter.ListListener
...
class MainFragment : Fragment() {
    ...
    private fun snapToCenter(
        ...
        return recyclerView.post(Runnable {
            ...
            if (view == null) {
                Log.e("ERROR", "Cant find target View for final snap")
                return@Runnable
            }
